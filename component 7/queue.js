...
// --------------------
function qDequeue() // take out the item that entered first -> First IN First Out
{
    var item = this.head.deleteFirst(); // Code a .deleteFirst() method for List, reuse to implement .dequeue
	return item;
}